...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Exam = __webpack_require__(159);
	...
	_reactDom2.default.render(_react2.default.createElement(_Exam2.default, { config: examConfig }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _whatwgFetch = __webpack_require__(160);

	var _whatwgFetch2 = _interopRequireDefault(_whatwgFetch);

	var _ExamQuestion = __webpack_require__(161);

	var _ExamQuestion2 = _interopRequireDefault(_ExamQuestion);

	var _ExamClock = __webpack_require__(163);

	var _ExamClock2 = _interopRequireDefault(_ExamClock);
	...
	var Exam = function (_React$Component) {
	    _inherits(Exam, _React$Component);

	    function Exam(props) {
	        _classCallCheck(this, Exam);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Exam).call(this, props));
	        ...
	        //load questions
	        fetch(props.config.examURL).then(function (response) {
	    ...
	    _createClass(Exam, [{
	        ...
	        value: function start(e) {
	            ...
	            fetch(this.state.startURL, { method: 'POST', body: data }).then(function (response) {
	                try {
	                    return response.json();
	                } catch (e) {
	                    return '';
	        ...
	        value: function finish() {
	            ...
	            fetch(this.state.finishURL, { method: 'POST', body: data }).then(function (response) {
	                return response.json();
	            }).then(function (json) {
	                if (json.Finished) {
	        ...
	        key: 'saveQuestion',
	        value: function saveQuestion(answer, duration, callback) {
	            if (this.state.saveURL) {
	                ...
	                fetch(this.state.saveURL, { method: 'POST', body: payload }).then(function (response) {
	                    return response.json();
	                }).then(function (json) {
	                    if (callback) {
	                        callback();
	        ...
	        value: function calculateTimeLeft(start) {
	        ...
	        value: function currentQuestionNumber() {
	            return this.state.activeQuestion + 1;
	        }
	    }, {
	        key: 'logDodgyActivity',
	        value: function logDodgyActivity() {
	            console.log('logging');
	                        ...
	                        if (this.state.finished) {
	                            ...
	                            return _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: 'info' },
	                                    _react2.default.createElement(_ExamClock2.default, { minutes: minutes, seconds: seconds }),
	                                    _react2.default.createElement(
	                                        'div',
	                                        { className: 'questions' },
	                                        'Question ',
	                                ...
	                                _react2.default.createElement(_ExamQuestion2.default, {
	                            ...
	                            return _react2.default.createElement(
	                                ...
	                                function () {
	                                    if (this.state.instructions) {
	                                        return _react2.default.createElement('div', { dangerouslySetInnerHTML: this.state.instructions });
	                                    }
	                                }.call(this),
	                                _react2.default.createElement(
	                                    'form',
	                                    { ref: 'startForm', name: 'frmStartForm', encType: 'application/x-www-form-urlencoded' },
	                                    _react2.default.createElement(
	                                        'div',
	                                        { className: 'fields' },
	                                        _react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'Name', ref: 'username', placeholder: 'Enter Your Name' })
	                                    ),
	                                    _react2.default.createElement(
	                                        'div',
	                                        { className: 'actions' },
	                                        _react2.default.createElement(
	                                            'button',
	                                            { className: 'btn btn-lg', onClick: this.start.bind(this) },
	                                            'Start'
	                                        )
	                                    )
	                                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ExamQuestionEditor = __webpack_require__(162);

	var _ExamQuestionEditor2 = _interopRequireDefault(_ExamQuestionEditor);
	...
	var ExamQuestion = function (_React$Component) {
	    _inherits(ExamQuestion, _React$Component);

	    function ExamQuestion(props) {
	        _classCallCheck(this, ExamQuestion);

	        //delay until it saves, cancels previous saves, prevents multiple saves triggered

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ExamQuestion).call(this, props));
	    ...
	    _createClass(ExamQuestion, [{
	        key: 'save',
	        value: function save(answer, callback) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('div', { className: 'question-text', dangerouslySetInnerHTML: getQuestion() }),
	                _react2.default.createElement(_ExamQuestionEditor2.default, { ref: 'editor', key: this.props.question.ID, onChange: this.save.bind(this) }),
	                _react2.default.createElement(
	                    'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExamQuestionEditor = function (_React$Component) {
	    _inherits(ExamQuestionEditor, _React$Component);

	    function ExamQuestionEditor(props) {
	        _classCallCheck(this, ExamQuestionEditor);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ExamQuestionEditor).call(this, props));

	        _this.state = {
	            html: ''
	        };

	        _this.styles = [{ regex: /(^='.*?')/gm, className: 'string' }, { regex: /(^=".*?")/gm, className: 'string' }, { regex: /(\$\w)/gm, className: 'variable' }];

	        _this.formatTimer = null;
	        _this.formatDelay = 100;

	        if (_this.refs.editor) _this.refs.editor.innerHTML = '';
	        return _this;
	    }

	    _createClass(ExamQuestionEditor, [{
	        key: 'onChange',
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'p',
	                    null,
	                    'Use Tab to indent, Shift+Tab to remove indent'
	                )
	            );
	        }
	    }]);

	    return ExamQuestionEditor;
	}(_react2.default.Component);

	exports.default = ExamQuestionEditor;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExamClock = function (_React$Component) {
	    _inherits(ExamClock, _React$Component);

	    function ExamClock(props) {
	        _classCallCheck(this, ExamClock);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ExamClock).call(this, props));
	    }

	    _createClass(ExamClock, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
